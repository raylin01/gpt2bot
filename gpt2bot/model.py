...
CONFIG_FILE = {
    ...
    'large': 'https://convaisharables.blob.core.windows.net/lsp/762M/config.json'
}
VOCAB_FILE = {
    ...
    'large': 'https://convaisharables.blob.core.windows.net/lsp/762M/vocab.json'
}
MERGE_FILE = {
    ...
    'large': 'https://convaisharables.blob.core.windows.net/lsp/762M/merges.txt'
}
