...
CONFIG_FILE = {
    ...
    'large': 'https://github.com/microsoft/DialoGPT/blob/master/configs/762M/config.json'
}
VOCAB_FILE = {
    ...
    'large': 'https://github.com/microsoft/DialoGPT/blob/master/configs/762M/vocab.json'
}
MERGE_FILE = {
    ...
    'large': 'https://github.com/microsoft/DialoGPT/blob/master/configs/762M/merges.txt'
}
...
LSP_MODEL_URL = {
    'multiref': {
        ...
        'large_ft': 'https://convaisharables.blob.core.windows.net/lsp/multiref/large_ft.pkl',
